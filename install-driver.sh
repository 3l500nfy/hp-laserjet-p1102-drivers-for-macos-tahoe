...
# HP LaserJet P1102 Driver Installer for macOS Tahoe 26.0.1
...
# The installer blocks versions > 15.0; we change to 27.0 so Tahoe 26.0.1 is allowed
print_green "Modifying the Distribution file to support macOS Tahoe 26.0.1..."
...
print_green "Creating the modified package for macOS Tahoe 26.0.1..."
pkgutil --flatten "$DRIVERS_DIR" HewlettPackardPrinterDrivers-tahoe.pkg

# Check if the new package was created
if [ ! -f "HewlettPackardPrinterDrivers-tahoe.pkg" ]; then
...
print_green "The modified driver package is: HewlettPackardPrinterDrivers-tahoe.pkg"
print_yellow "You can now install the driver by double-clicking on HewlettPackardPrinterDrivers-tahoe.pkg"
